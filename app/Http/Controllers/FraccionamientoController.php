...
class FraccionamientoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $fraccionamiento->propietaria = ucwords(strtolower($validated['propietaria']));
            ...
            $fraccionamiento->viento1 = ucwords(strtolower($validated['viento1']));
            $fraccionamiento->viento2 = ucwords(strtolower($validated['viento2']));
            $fraccionamiento->viento3 = ucwords(strtolower($validated['viento3']));
            $fraccionamiento->viento4 = ucwords(strtolower($validated['viento4']));
