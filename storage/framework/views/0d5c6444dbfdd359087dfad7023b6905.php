 <div class="row g-3">
    ...
    <div class="col-md-4">
        ...
        <input type="number" step="0.01" name="frente_m" id="frente_m" class="form-control" required>
    </div>
    ...
    <div class="col-md-6">
        ...
        <input type="number" step="0.01" name="precio_contado" id="precio_contado" class="form-control" required>
    </div>

    <div class="col-md-6">
        <label for="precio_credito" class="form-label">Precio Crédito</label>
        <input type="number" step="0.01" name="precio_credito" id="precio_credito" class="form-control" required>
    </div>
