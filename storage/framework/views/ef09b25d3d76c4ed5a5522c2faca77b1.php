 <div class="modal fade" id="editEstatusProyecto(<?php echo e($proy->id); ?>)" tabindex="-1" aria-labelledby="editSede" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?php echo e(route('estatus-proyectos.update', ['estatus_proyecto' => $proy->id])); ?>" autocomplete="off">
                    <?php echo csrf_field(); ?>
