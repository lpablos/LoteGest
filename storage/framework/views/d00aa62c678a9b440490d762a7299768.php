        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                ...
                <img class="rounded-circle header-profile-user" src="<?php echo e(isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('build/images/users/avatar-1.jpg')); ?>"
                    alt="Header Avatar">
                <span class="d-none d-xl-inline-block ms-1" key="t-henry"><?php if(Auth::check()): ?> <?php echo e(ucfirst(Auth::user()->nombre)); ?> <?php echo e(ucfirst(Auth::user()->primer_apellido)); ?> <?php endif; ?> </span>
                <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
            </button>
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <a class="dropdown-item" href="contacts-profile"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile"> Mi Perfil </span></a>
                
                
                
                <div class="dropdown-divider"></div>
                <a class="dropdown-item text-danger" href="javascript:void();" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-power-off font-size-16 align-middle me-1 text-danger"></i> <span key="t-logout"> Cerrar sesión </span></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="change-password">
                    <?php echo csrf_field(); ?>
                    <?php if(Auth::check()): ?> <input type="hidden" value="<?php echo e(Auth::user()->id); ?>" id="data_id"><?php endif; ?>
                    <div class="mb-3">
...
<?php /**PATH /Users/luisjorgepablosartillo/Documents/PROYECTOS/LoteGest/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>