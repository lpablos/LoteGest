                    ...
                    <table id="datatable-estatus-proyecto" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        <tbody>
                              <?php $__currentLoopData = $lotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($lote->nombre); ?></td>
                                        <td> <?php echo e(Carbon\Carbon::parse($lote->fecha_inicio)->format('d-m-Y')); ?> </td>
                                        <td><?php echo e($lote->responsable_proyecto); ?></td>
                                        <td><?php echo e($lote->estatus->nombre); ?></td>      
                                        <td>
                                            <div class="dropdown">
