...
<?php $__env->startSection('content'); ?>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="datatable-estatus-proyecto" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $tipoDePredios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipoDePredio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($tipoDePredio->nombre); ?></td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-start">
                                                <li><a href="#editCatTipoPredio(<?php echo e($tipoDePredio->id); ?>)" data-bs-toggle="modal" class="dropdown-item" data-edit-id="<?php echo e($tipoDePredio->id); ?>"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Editar </a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
                                <div class="modal fade" id="editCatTipoPredio(<?php echo e($tipoDePredio->id); ?>)" tabindex="-1" aria-labelledby="editSede" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="<?php echo e(route('tipo-de-predios.update', ['tipo_de_predio' => $tipoDePredio->id])); ?>" autocomplete="off">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PUT'); ?>
                                                    <div class="row col-md-12">
                                                        <div class="col-md-12 mb-3">
                                                            <label for="nombre" class="col-form-label"> Nombre </label>
                                                            <input type="text" class="form-control form-control-sm" name="nombre" onkeyup="javascript:this.value=this.value.toLowerCase();" required value="<?php echo e($tipoDePredio->nombre); ?>">
                                                        </div>
                                                    </div>
    ...
    <?php echo $__env->make('pages.cat_tipo_predio.add', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/luisjorgepablosartillo/Documents/PROYECTOS/LoteGest/resources/views/pages/cat_tipo_predio/index.blade.php ENDPATH**/ ?>