...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="datatable-estatus" class="table table-bordered dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                <th> Nombre </th>
                                <th> Descripción </th>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $estatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($status->descripcion); ?></td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-start">
                                                <li><a href="#editEstatus(<?php echo e($status->id); ?>)" data-bs-toggle="modal" class="dropdown-item" data-edit-id="<?php echo e($status->id); ?>"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Editar </a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
                                <div class="modal fade" id="editEstatus(<?php echo e($status->id); ?>)" tabindex="-1" aria-labelledby="editSede" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="editSede"> Editar Estatus </h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form method="POST" action="<?php echo e(route('estatus.update', ['estatus' => $status->id])); ?>" autocomplete="off">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PUT'); ?>
                                                    <div class="row col-md-12">
                                                        <div class="col-md-12 mb-3">
                                                            <label for="nombre" class="col-form-label"> Nombre </label>
                                                            <input type="text" class="form-control form-control-sm" name="nombre" onkeyup="javascript:this.value=this.value.toLowerCase();" required value="<?php echo e($status->nombre); ?>">
                                                        </div>
                                                        <div class="col-md-12 mb-3">
                                                            <label for="descripcion" class="col-form-label"> Descripción </label>
                                                            <input type="text" class="form-control form-control-sm" name="descripcion" required value="<?php echo e($status->descripcion); ?>">
                                                        </div>
    ...
    <?php echo $__env->make('pages.estatus.add', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            //Buttons examples
            var table = $('#datatable-estatus').DataTable({
                language: {
            ...
            table.buttons().container().appendTo('#datatable-estatus_wrapper .col-md-6:eq(0)');
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/luisjorgepablosartillo/Documents/PROYECTOS/LoteGest/resources/views/pages/estatus/index.blade.php ENDPATH**/ ?>