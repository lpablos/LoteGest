<div class="row g-3">
    ...
    <div class="col-md-6">
        ...
        <select name="clientes" id="clientes<?php echo e($lote->id ?? ''); ?>" class="form-select" required >
      ...
      <div class="col-md-6">
        ...
        <select name="clavesAsc" id="clientes<?php echo e($lote->id ?? ''); ?>" class="form-select" required >
...
</div><?php /**PATH /Users/luisjorgepablosartillo/Documents/PROYECTOS/LoteGest/resources/views/pages/contratos/formulario/cliente.blade.php ENDPATH**/ ?>