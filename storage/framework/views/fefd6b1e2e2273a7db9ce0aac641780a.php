...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', 'director@arquitectos.com')); ?>" id="username" placeholder="Ingresa el email" autocomplete="email" autofocus>
...
unset($__errorArgs, $__bag); ?>" id="userpassword" value="12345678" placeholder="Ingrese la contraseña" aria-label="Password" aria-describedby="password-addon">
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/luisjorgepablosartillo/Documents/PROYECTOS/LoteGest/resources/views/auth/login.blade.php ENDPATH**/ ?>