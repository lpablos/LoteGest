    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
           <div class="modal-header align-items-center">
                ...
                <button type="button" class="btn-close ms-auto" data-bs-dismiss="modal<?php echo e($lote->id); ?>" aria-label="Close"></button>
            </div>
...
<?php /**PATH /Users/luisjorgepablosartillo/Documents/PROYECTOS/LoteGest/resources/views/pages/gestion-lotes/modal/edit.blade.php ENDPATH**/ ?>