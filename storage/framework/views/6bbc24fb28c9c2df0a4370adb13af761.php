                        ...
                        <tbody>
                            <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td> <?php echo e(Carbon\Carbon::parse($usuario->updated_at)->format('d-m-Y H:i:s')); ?> </td>
                                    <td><?php if($usuario->estatus_id == 1): ?> <span class="badge bg-success font-size-12"> <?php echo e($usuario->estatus); ?> </span> <?php else: ?> <span class="badge bg-danger font-size-12"> <?php echo e($usuario->estatus); ?></span><?php endif; ?></td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-start">
                                                ...
                                                <li>
                                                    <a class="dropdown-item des_activar_usuario" style="cursor: pointer;" data-id="<?php echo e($usuario->id); ?>" data-estatus="<?php echo e($usuario->estatus_id); ?>">
                                                        <?php if($usuario->estatus_id == 1): ?>
