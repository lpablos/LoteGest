        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="datatable-entidades" class="table table-bordered dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                <th> Nombre </th>
                                <th> Acciones </th>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $entidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entidad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($entidad->nom_estado); ?></td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-start">
                                                <li><a href="#editEntidadFederativa(<?php echo e($entidad->id); ?>)" data-bs-toggle="modal" class="dropdown-item" data-edit-id="<?php echo e($entidad->id); ?>"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Editar </a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
                                <div class="modal fade" id="editEntidadFederativa(<?php echo e($entidad->id); ?>)" tabindex="-1" aria-labelledby="editSede" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="editSede"> Editar entidad </h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form method="POST" action="<?php echo e(route('entidades-federativas.update', ['entidades_federativa' => $entidad->id])); ?>" autocomplete="off">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PUT'); ?>
                                                    <div class="row col-md-12">
                                                        <div class="col-md-12 mb-3">
                                                            <label for="nombre" class="col-form-label"> Nombre </label>
                                                            <input type="text" class="form-control form-control-sm" name="nombre" onkeyup="javascript:this.value=this.value.toLowerCase();" required value="<?php echo e($entidad->nom_estado); ?>">
                                                        </div>
                                                    </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            //Buttons examples
            var table = $('#datatable-entidades').DataTable({
                language: {
            ...
            table.buttons().container().appendTo('#datatable-entidades_wrapper .col-md-6:eq(0)');
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/luisjorgepablosartillo/Documents/PROYECTOS/LoteGest/resources/views/pages/cat_entidades_federativas/index.blade.php ENDPATH**/ ?>