                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-start">
                                                <li><a href="#editRol({{ $rol->id }})" data-bs-toggle="modal" class="dropdown-item" data-edit-id="{{ $rol->id }}"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Editar </a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
                                <div class="modal fade" id="editRol({{ $rol->id }})" tabindex="-1" aria-labelledby="editSede" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="{{ route('perfiles.update', ['perfile' => $rol->id]) }}" autocomplete="off">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="row col-md-12">
                                                        <div class="col-md-12 mb-3">
                                                            <label for="nombre" class="col-form-label"> Nombre </label>
                                                            <input type="text" class="form-control form-control-sm" name="nombre" required value="{{ $rol->nombre }}">
                                                        </div>
                                                    </div>
